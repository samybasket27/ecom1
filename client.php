 ...
 */
    ...
    class clientPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_clt', true, true, true),
                    new StringField('username', true),
                    new StringField('password', true),
                    new DateField('date_creation', true)
                )
            );
        }
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_clt', 'id_clt', 'Id Clt'),
                new FilterColumn($this->dataset, 'username', 'username', 'Username'),
                new FilterColumn($this->dataset, 'password', 'password', 'Password'),
                new FilterColumn($this->dataset, 'date_creation', 'date_creation', 'Date Creation')
            );
        }
        ...
        {
            $quickFilter
                ->addColumn($columns['id_clt'])
                ->addColumn($columns['username'])
                ->addColumn($columns['password'])
                ->addColumn($columns['date_creation']);
        }
    
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            $columnFilter
                ->setOptionsFor('date_creation');
        }
    
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            $main_editor = new TextEdit('id_clt_edit');
            ...
            $main_editor = new TextEdit('username');
            ...
            $main_editor = new DateTimeEdit('date_creation_edit', false, 'Y-m-d');
        ...
        {
            //
            // View column for id_clt field
            //
            $column = new NumberViewColumn('id_clt', 'id_clt', 'Id Clt', $this->dataset);
            ...
            //
            $column = new DateTimeViewColumn('date_creation', 'date_creation', 'Date Creation', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new DateTimeEdit('date_creation_edit', false, 'Y-m-d');
    ...
    try
    {
        $Page = new clientPage("client", "client.php", GetCurrentUserPermissionsForPage("client"), 'UTF-8');
