...
{
    $result = array();
    $result[] = array('caption' => 'Categorie', 'short_caption' => 'Categorie', 'filename' => 'categorie.php', 'name' => 'categorie', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Client', 'short_caption' => 'Client', 'filename' => 'client.php', 'name' => 'client', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Produit', 'short_caption' => 'Produit', 'filename' => 'produit.php', 'name' => 'produit', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
